...
class CardsTestCase(unittest.TestCase):
    ...
    def test_init_from_str(self):
        h = cards.Cards.from_str("2s 3d 4h")
    ...
    def test_combine(self):
        h1 = cards.Cards.from_str("2c 3d")
        h2 = cards.Cards.from_str("4h 5s")
        self.assertEqual("2c 3d 4h 5s", str(h1.combine(h2)))
    
    def test_hand_rank_too_few_cards(self):
        with self.assertRaises(ValueError):
            cards.Cards.from_str("2s 3c").hand_rank()
